#!/usr/bin/python3
"""Unittest Base Model for base model class"""
...
class TestBaseModel(unittest.TestCase):
    ...
    def test_3_init_no_args(self):
        """Test __inits__ with no arguments"""
        self.resetStorage()
    ...
    def test_3_attributes(self):
        """Test attribute value for instance of a base Model class"""
    ...
    def test_3_datetime_created(self):
        """Test if updated_at and created_at are current at creation."""
    ...
    def test_3_to_dict_excess_args(self):
        ...
        self.resetStorage()
        with self.asssertRaises(TypeError) as e:
